...
sponge.addEventListener("click", function(){
    if(canChoose && myChoice === "" && playerOneConnected && playerTwoIsConnected){
        myChoice = "sponge";
        choose(myChoice);
        socket.emit("make-move", {playerId, myChoice, roomId});
...
function setPlayerTag(playerId){
    if(playerId === 1){
        playerOneTag.innerText = "You";
        playerTwoTag.innerText = "Player 2";
    }else{
        playerOneTag.innerText = "Player 2";
        playerTwoTag.innerText = "You";
    }
}
...
function choose(choice){
    if(choice === "rock"){
        ...
        gun.classList.add("my-choice");
    }else if(choice === "water"){
        water.classList.add("my-choice");
    }else if(choice === "air"){
        air.classList.add("my-choice");
    }else if(choice === "sponge"){
        sponge.classList.add("my-choice");
    }else if(choice === "human"){
        human.classList.add("my-choice");
    }else if(choice === "fire"){
        fire.classList.add("my-choice");
    }else{
...
function removeChoice(choice){
    if(choice === "rock"){
        ...
        gun.classList.remove("my-choice");
    }else{
